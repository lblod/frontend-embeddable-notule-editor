  ...
  build: {
    ...
    rollupOptions: {
      input: [
        ...
        path.resolve(__dirname, 'test-app/headless-test/index.html'),
        path.resolve(__dirname, 'test-app/locked-placeholders/index.html'),
        path.resolve(__dirname, 'test-app/custom-headless-editing/index.html'),
      ],
    },
  },
});
